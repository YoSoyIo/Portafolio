...
function botonPrompt(){
    let ciudad = prompt("Menciona el nombre de una ciudad de Brasil: ");
...
function suma(){
    ...
    let valor2 = prompt("Ingresa un segundo numero: ");

    alert(`La suma de ${valor1} + ${valor2} = ${parseInt(valor1)+parseInt(valor2)}`);
}
